...
De todas las métricas disponibles se han seleccionado Accuracy y LogLoss para evaluar la capacidad del modelo para predecir ambos niveles de la variable de clase y obvservar como la métrica es penalizada en el valor del LogLoss.
